 ...
 * ID: 
  Primary key, integer olarak tanımlandı. Satırın id değerini tutuyor.
 * guitar: 
  Boolean olarak tanımlandı. Kullanıcının gitar çalmayı sevip sevmediği bilgisini tutuyor.
 * basketball: 
  Boolean olarak tanımlandı. Kullanıcının basketbol sevip sevmediği bilgisini tutuyor.
 * football: 
  Boolean olarak tanımlandı. Kullanıcının futbol sevip sevmediği bilgisini tutuyor.
...
Ekleme 
^^^^^^
Bu operasyon kullanıcının hobilerinin tutan kaydı eklemek için kullanılır. 

Güncelleme 
^^^^^^^^^^
Bu operasyon kullanıcının hobilerini güncellemek için kullanılır. 
